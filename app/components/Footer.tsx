...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      url: 'https://web.facebook.com/profile.php?id=61583403234776',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/axivers.clothing/',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/110519950',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'Pinterest',
      url: 'https://www.pinterest.com/axiversclothing/',
      icon: (
        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-brand-light/10">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <ul className="space-y-2 text-xs font-light text-brand-light/60">
            ...
            <li><a href="/products" className="hover:text-white transition-colors">Essentials</a></li>
          </ul>
        </div>
